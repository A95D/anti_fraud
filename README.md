...
2. [Архитектура](#1-архитектура-хранилища)
3. [База данных](#2-база-данных-банка)
4. [ETL-процесс](#3-реализация-etl-логики)
5. [Витрина данных и визуализация](#примеры-визуализации)
6. [Установка и запуск](#установка-и-настройка)
